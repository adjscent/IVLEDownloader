...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_recentFileAction_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_recentFileAction_t qt_meta_stringdata_recentFileAction = {
    {
QT_MOC_LITERAL(0, 0, 16), // "recentFileAction"
QT_MOC_LITERAL(1, 17, 7), // "setFile"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 8), // "filePath"
QT_MOC_LITERAL(4, 35, 8) // "openFile"
...
const QMetaObject recentFileAction::staticMetaObject = {
    { &QAction::staticMetaObject, qt_meta_stringdata_recentFileAction.data,
      qt_meta_data_recentFileAction,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *recentFileAction::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_recentFileAction.stringdata0))
